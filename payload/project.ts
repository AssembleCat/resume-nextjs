  ...
  list: [
    ...
    },
    {
      ...
      descriptions: [
        ...
        },
        {
          weight: 'MEDIUM',
          content:
            '하나의 계정으로 10개 이상의 서비스를 이용할 수 있도록 SSO 기반의 통합 인증 시스템을 설계 및 구현했습니다.',
        },
        {
    ...
    },
    {
      ...
      descriptions: [
        ...
        {
          content:
            '브랜드마다 요구사항이 다르므로, 공통 모듈을 유지하면서도 브랜드별로 환경설정 및 플러그인 형태로 기능 확장이 가능한 구조로 개발했습니다.',
        },
        {
          content:
    ...
    },
    {
      ...
      descriptions: [
        ...
        {
          content:
            'ACK(확인 응답) 기반의 장애 대응 및 중복 데이터 검증 로직을 도입하여 데이터 신뢰성을 향상시켰습니다.',
        },
        {
          content:
