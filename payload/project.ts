      ...
      descriptions: [
        {
          weight: 'MEDIUM',
          content:
            '기존에는 10개 이상의 브랜드별로 개별 KIOSK 프로젝트를 개발하여 유지보수 및 확장이 어려운 문제가 있었습니다. 이를 해결하기 위해 여러 브랜드에서 공통으로 사용할 수 있는 통합 KIOSK 시스템을 설계하고 개발했습니다.',
        },
        {
          content:
      ...
      descriptions: [
        {
          weight: 'MEDIUM',
          content:
            '매장에 배포된 여러 KIOSK가 생성한 4만개 이상의 결제 데이터를 메시지 큐 기반의 비동기 아키텍처로 중앙 서버에 전송하는 시스템을 설계 및 구현했습니다.',
        },
        {
          content:
